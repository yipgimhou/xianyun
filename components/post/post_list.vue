      ...
      <div class="content">
        ...
        <el-row type="flex" justify="space-between" class="content_bottom">
          <el-col :span="20" class="left">
            ...
            <img src="http://157.122.54.189:9095/assets/images/avatar.jpg" /><span>地球发动机</span>
            <i class="el-icon-view"></i>12805
          </el-col>
          <el-col :span="2" class="right">74赞</el-col>
        </el-row>
      </div>
    </div>
    <div class="contentList">
